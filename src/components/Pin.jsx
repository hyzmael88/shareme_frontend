            ...
            <div className="flex items-center justify-between">
              <div className="flex gap-2">
                <a
                  ...
                  /*sirve para que el click solo funcione aqui y no se siga a traves de la imagen*/ className="bg-white w-9 h-9 rounded-full flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none"
                >
